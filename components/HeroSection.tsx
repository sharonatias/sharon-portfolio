  ...
  return (
    <div className="relative w-full h-screen bg-black overflow-hidden">
      ...
      {showHeader && videoLoaded && (
        <header className={`fixed top-0 right-0 left-0 px-8 lg:px-20 pt-8 pb-16 transition-all duration-300 ${showHeader ? 'translate-y-0 opacity-100' : '-translate-y-full opacity-0'} z-40 flex justify-end`} dir="rtl">
